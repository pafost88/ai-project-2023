    ...
    return (
        <>
            <div className='form-label'>
                <span className='header-label'>Check your email</span>
                <span className='label-description'>We sent a reset link to <span className='user-email'>hello@myplanet.design</span></span>
            </div>
